...
cap.setCapability("udid", "192.168.100.70:5555");
...
MobileElement google=driver.findElement(By.id("com.samsung.android.contacts:id/radio_button"));
google.click();

MobileElement google1=driver.findElement(By.id("android:id/button2"));
google1.click();

MobileElement name=driver.findElement(By.id("com.samsung.android.contacts:id/name_editor"));
name.click();
driver.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);
driver.getKeyboard();
name.sendKeys("Nabeel");
